"""
GraphSAGE training loop with neighbor sampling, early stopping, and tracking.
"""
...
from hgad_cms.graphsage.config import GraphSAGEConfig
from hgad_cms.graphsage.inference import FoldGraphData, predict_provider_scores
...
class FoldTrainResult:
    """Training outcome for one CV fold."""
...
class GraphSAGETrainer:
    """Train heterogeneous GraphSAGE with mini-batch neighbor sampling."""
    ...
    def __init__(
        ...
        *,
        ...
        self.last_model: HeteroGraphSAGE | None = None

    def _make_model(self, fold_data: FoldGraphData) -> HeteroGraphSAGE:
    ...
    def train_fold(
        ...
        *,
        ...
        """Train GraphSAGE on one fold with early stopping on validation AUPRC."""
